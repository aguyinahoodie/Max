...
def mark_owned(args):
    ...
    if (args.clear):
        ...
        query = (
            ...
            "SET n.system_tags = trim(replace(n.system_tags,'owned',''))"
        )
        ...
        for line in f:
            ...
            tag_query = (
                ...
                "WHEN NOT n.system_tags CONTAINS 'owned' THEN trim(n.system_tags + ' owned') "
                "ELSE n.system_tags END"
            )
...
def mark_hvt(args):
    ...
    if (args.clear):
        ...
        query = (
            ...
            "SET n.system_tags = trim(replace(n.system_tags,'admin_tier_0',''))"
        )
        r = do_query(args,query)
        ...
        for line in f:
            ...
            tag_query = (
                "SET n.system_tags = CASE "
                "WHEN n.system_tags IS NULL THEN 'admin_tier_0' "
                "WHEN NOT n.system_tags CONTAINS 'admin_tier_0' THEN trim(n.system_tags + ' admin_tier_0') "
                "ELSE n.system_tags END"
            )
...
def dpat_func(args):
    ...
    if args.own_cracked:
        ...
        own_cracked_query=(
            ...
            "WHEN NOT u.system_tags CONTAINS 'owned' THEN trim(u.system_tags + ' owned') "
            "ELSE u.system_tags END"
        )
    ...
    if args.add_crack_note:
        ...
        add_crack_note_query=(
            "MATCH (u:User {cracked:True}) "
            "SET u.system_tags = CASE "
            "WHEN u.system_tags IS NULL THEN 'password_cracked' "
            "WHEN NOT u.system_tags CONTAINS 'password_cracked' THEN trim(u.system_tags + ' password_cracked') "
            "ELSE u.system_tags END"
        )
