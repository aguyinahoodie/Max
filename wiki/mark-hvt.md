...
Bulk import of HVT objects into the database using the `admin_tier_0` system tag
...
* `--clear` will remove the `admin_tier_0` system tag from every object (including those set by default, be careful)
